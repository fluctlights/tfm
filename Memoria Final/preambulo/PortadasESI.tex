...
\begin{titlepage}
	...
	\begin{center}
		...
		%{\LARGE \textbf{\@tipoDoc}}\\[1cm]	% creo que hay que comentar esto
		{\LARGE \@tituloPrimera}\\ \smallskip%			
		\ifdefined\@tituloSegunda{\LARGE \begin{center} \@tituloSegunda \end{center}}\\[3cm]
...
%		(EN: Specialization in ...)
		...
		{\LARGE {\@tituloPrimera} \smallskip%		
		%\ifdefined \@tituloSegunda {\LARGE {\@tituloSegunda}}
	...
	\begin{flushleft}
		...
		{\Large Tutor: Jesús Barba Romero} \\ \bigskip% (EN: Co-Supervisor)
		{\Large Co-tutora: María Soledad Escolar Díaz}
	\end{flushleft}
	\vspace{2cm}%
	\begin{flushright}
		{\Large \ifspanish \@mesTF \else \@monthTF \fi, \@yearTF}
...
Por estar ahí cuando más se necesita}
\end{flushright}
\vspace{\stretch{2}}\null
\cleardoublepage
