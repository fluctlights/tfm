...
class ARM_A72_BP(TournamentBP):
    # TournamentBP and Bi-Mode predictors are global-based predictors
    # No static predictor on gem5. IndirectPredictor is already set and used by
    # default. RAS is set and used by default.
    #Information taken fully from HPI.py
