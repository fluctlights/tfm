...
try:
    ...
    with open('/home/fluctlights/Escritorio/Repos/tfm/Codigo/Codigo-GEM5/Benchmarks/reduced_stats.txt', 'r') as file:
        for line in file:
    ...
    df.to_excel('/home/fluctlights/Escritorio/Repos/tfm/Codigo/Codigo-GEM5/Benchmarks/resultados.xlsx', index=False)
...
main()
{
    ...
    output_file="$CODE_PATH/Benchmarks/reduced_stats.txt"
