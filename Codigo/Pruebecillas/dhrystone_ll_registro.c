...
/*****************************************************
DEFINICION DE FUNCION DE LECTURA DE REGISTRO DE CICLOS
******************************************************/
...
*****************/
	...
	uint64_t start_val = read_pmccntr();
...
-- Stop Cycles  --
*****************/
	uint64_t finish_val = read_pmccntr();
	printf("%llu cycles to complete %d LOOP\n",(finish_val - start_val), LOOPS);
}
